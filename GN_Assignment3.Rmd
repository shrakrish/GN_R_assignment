...
MergedCombined = melt(MergedCombined)
...
```
The first graph has the PositionRange on the X-axis. This mutated category is just the Position column binned into five groups. The choice of 5 is arbitary, but it shows that several of the chromosomes have SNPs in roughly the 1st bin only. This could be from those chromosomes being smaller, or the SNPs measured just all being in that region of those chromosomes. 

The second graph is the density split by all the chromosomes. 
```{r}
